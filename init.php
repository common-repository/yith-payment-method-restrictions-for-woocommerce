<?php
/*
Plugin Name: YITH Payment Method Restrictions for WooCommerce
Plugin URI: https://yithemes.com/themes/plugins/yith-auctions-for-woocommerce/
Description: Hide specific payment methods based on the products in cart.
Author: YITHEMES
...
/* === DEFINE === */
! defined( 'YITH_WCPMR_VERSION' )            && define( 'YITH_WCPMR_VERSION', '1.1.2' );
! defined( 'YITH_WCPMR_FREE_INIT' )          && define( 'YITH_WCPMR_FREE_INIT', plugin_basename( __FILE__ ) );
! defined( 'YITH_WCPMR_SLUG' )               && define( 'YITH_WCPMR_SLUG', 'yith-payment-method-restrictions-for-woocommerce' );
! defined( 'YITH_WCPMR_SECRETKEY' )          && define( 'YITH_WCPMR_SECRETKEY', 'XxtNaEuK0GstyQtxkbr8' );
...
add_action( 'yith_wcpmr_init', 'yith_wcpmr_init' );